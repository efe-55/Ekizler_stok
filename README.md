...
Supabase'in ücretsiz katmanı, **yeterince aktif kullanılmadığını** düşünürse projeyi otomatik durduruyor.
Supabase'in kendi belgelerine göre bunun için haftada bir-iki istek yetmiyor — **son bir hafta
boyunca her gün** birkaç istek gelmesi gerekiyor. Bu klasörde bunu sağlayan, **her gün** otomatik
"merhaba" mesajı gönderen ücretsiz bir görev (`keep-alive.yml`) zaten hazır — sadece
...
4. Bu kadar. Görev otomatik olarak **her gün** çalışıp veritabanınızı uyanık tutacak — siz hiçbir şey yapmayacaksınız.
